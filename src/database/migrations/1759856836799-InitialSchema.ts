...
export class InitialSchema1759856836799 implements MigrationInterface {
  name = 'InitialSchema1759856836799';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "access_right" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "roleId" uuid NOT NULL, "module" "public"."access_right_module_enum" NOT NULL, "canRead" boolean NOT NULL DEFAULT true, "canWrite" boolean NOT NULL DEFAULT false, "canDelete" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_f7546dadb2695255e11d29b22ee" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "role" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "organizationId" uuid NOT NULL, "name" character varying(100) NOT NULL, "description" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b36bcfe02fc8de3c57a8b2391c2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."organization_plantype_enum" AS ENUM('FREE', 'PRO', 'ENTERPRISE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."organization_user_status_enum" AS ENUM('ACTIVE', 'INACTIVE', 'SUSPENDED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."audit_log_action_enum" AS ENUM('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'ASSIGN_ROLE', 'CHANGE_PLAN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "access_right" ADD CONSTRAINT "FK_b6a1db3afb2c7838e756f114f49" FOREIGN KEY ("roleId") REFERENCES "role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "role" ADD CONSTRAINT "FK_2bcd50772082305f3bcee6b6da4" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "store" ADD CONSTRAINT "FK_131cfaf1fa490aa45d17ea9d0f6" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "organization_user" ADD CONSTRAINT "FK_a78cdb366cf1bbcaf584a48a7e5" FOREIGN KEY ("storeId") REFERENCES "store"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "audit_log" ADD CONSTRAINT "FK_0cd772ccf5e17f911bf17f9602d" FOREIGN KEY ("storeId") REFERENCES "store"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "audit_log" DROP CONSTRAINT "FK_0cd772ccf5e17f911bf17f9602d"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "organization_user" DROP CONSTRAINT "FK_a78cdb366cf1bbcaf584a48a7e5"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "store" DROP CONSTRAINT "FK_131cfaf1fa490aa45d17ea9d0f6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "role" DROP CONSTRAINT "FK_2bcd50772082305f3bcee6b6da4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "access_right" DROP CONSTRAINT "FK_b6a1db3afb2c7838e756f114f49"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."organization_user_status_enum"`,
    );
